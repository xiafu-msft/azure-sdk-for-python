...
from .._serialize import get_api_version, get_modify_conditions
...
class BlobClient(AsyncStorageAccountHostsMixin, BlobClientBase):
    ...
    async def set_blob_tags(self, tags: Optional[Dict[str, str]]=..., **kwargs: Any) -> Dict[str, Any]: ...
    ...
    async def get_page_range_diff_for_managed_disk(self, previous_snapshot_url: str, offset: Optional[int]=..., length: Optional[int]=..., **kwargs: Any) -> Tuple[List[Dict[str, int]], List[Dict[str, int]]]: ...
