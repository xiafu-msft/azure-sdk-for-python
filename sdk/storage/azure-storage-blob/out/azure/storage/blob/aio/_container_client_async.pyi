...
from typing import Any, AnyStr, AsyncIterator, Dict, IO, Iterable, List, Optional, Union
...
class ContainerClient(AsyncStorageAccountHostsMixin, ContainerClientBase):
    ...
    async def undelete_container(self, deleted_container_name: str, deleted_container_version: str, **kwargs: Any) -> None: ...
    ...
    def list_blobs(self, name_starts_with: Optional[str]=..., include: Optional[Union[str, List[str]]]=..., **kwargs: Any) -> AsyncItemPaged[BlobProperties]: ...
