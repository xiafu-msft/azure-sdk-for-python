...
class DataLakeDirectoryClient(PathClient):
    ...
    def create_directory(self, metadata: Optional[Dict[str, str]]=..., **kwargs: Any) -> Dict[str, Union[str, datetime]]: ...
    ...
    def create_sub_directory(self, sub_directory: Union[DirectoryProperties, str], metadata: Optional[Dict[str, str]]=..., **kwargs: Any) -> DataLakeDirectoryClient: ...
