...
from ._models import FileSystemProperties, LocationMode, PathPropertiesPaged, PublicAccess
...
class FileSystemClient(StorageAccountHostsMixin):
    ...
    def create_directory(self, directory: Union[DirectoryProperties, str], metadata: Optional[Dict[str, str]]=..., **kwargs: Any) -> DataLakeDirectoryClient: ...
    ...
    def delete_file(self, file: Union[FileProperties, str], **kwargs: Any) -> DataLakeFileClient: ...
