...
class DataLakeFileClient(PathClient, DataLakeFileClientBase):
    ...
    async def upload_data(self, data: Union[AnyStr, Iterable[AnyStr], IO[AnyStr]], length: Optional[int]=..., overwrite: Optional[bool]=..., **kwargs: Any) -> Dict[str, Any]: ...
    ...
    async def download_file(self, offset: Optional[int]=..., length: Optional[int]=..., **kwargs: Any) -> StorageStreamDownloader: ...
