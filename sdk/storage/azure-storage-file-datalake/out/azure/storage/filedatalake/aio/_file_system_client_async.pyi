...
class FileSystemClient(AsyncStorageAccountHostsMixin, FileSystemClientBase):
    ...
    async def set_file_system_metadata(self, metadata: Dict[str, str], **kwargs: Any) -> Dict[str, Union[str, datetime]]: ...
    ...
    async def create_directory(self, directory: Union[DirectoryProperties, str], metadata: Optional[Dict[str, str]]=..., **kwargs: Any) -> DataLakeDirectoryClient: ...
    ...
    async def delete_file(self, file: Union[FileProperties, str], **kwargs: Any) -> DataLakeFileClient: ...
