...
from ._serialize import get_access_conditions, get_api_version, get_smb_properties, get_source_conditions
...
class ShareFileClient(StorageAccountHostsMixin):
    ...
    def acquire_lease(self, lease_id: Optional[str]=..., **kwargs: Any) -> BlobLeaseClient: ...
